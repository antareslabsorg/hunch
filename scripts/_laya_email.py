# Vendored from https://github.com/NandhaKishorM/laya (laya/email.py), Apache-2.0, fetched 2026-09-23.
# MODIFIED (Apache-2.0 §4(b)): one package-relative import was removed so the file runs standalone; nothing else changed.
# Used only to rebuild Laya's e-mail benchmark states exactly as their code does (email_state / clean_email_body).
